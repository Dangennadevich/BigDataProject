...
if __name__ == "__main__":
    ...
    local_storage = LocalFileSystem(basepath="~/prefect/flows")
    local_storage.save(name="my-local-storage")
    etl_process.from_source(
        source=local_storage,
        entrypoint="/home/hadoop/prefect/hw-5_deploy.py:etl_process"
    ).deploy(
        name='ETL deployment',
